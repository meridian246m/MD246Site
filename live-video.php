...
<head>
	...
	<title>MeriDian 246 - Живе Відео | Сучасний Рок-гурт | Україна</title>
	<meta name="description" CONTENT="Новини, Статті, Заходи - Meridian 246 м.Олешки +38993907684">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="smooth-scroll"><a href="index.php#news">НОВИНИ</a></li>
...
<section id="gallery">
		...
		<div class="row">
			<div class="col-sm-10 col-sm-offset-1">
				<div class="section-heading text-center text-uppercase  wow shake">
					<h2>ВІДЕО <span>З ЖИВИХ ВИСТУПІВ</span></h2>
	...
	<div class="text-center text-uppercase">
		<a href="video-clip.php#gallery" class="btn btn-trans">КЛІПИ</a>
		<a href="#" class="active btn btn-trans" data-filter=".design">ВІДЕО З ВИСТУПІВ</a>
...
<!----Відео з виступів------->
			...
			<!--	<iframe width="300" height="300" src="" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>	-->				
